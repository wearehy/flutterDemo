...
class CopyFullGroup extends StatefulWidget {
  @override
  _CopyFullGroupState createState() => _CopyFullGroupState();
}

class _CopyFullGroupState extends State<CopyFullGroup> {
  int _currentIndex = 0;
  @override
